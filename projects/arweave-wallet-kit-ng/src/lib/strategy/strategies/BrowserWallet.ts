...
export default class BrowserWalletStrategy implements Strategy {
  public id: string = "browserwallet";
  public name: string = "Browser Wallet";
  public description: string = "Any browser wallet with an injected API";
  public theme: string = "121,212,131";
  public logo: string = "KKiSlNKc5K59MXzUPz5qjtCLsl6_ckjAOg9MyAzaUs0";
